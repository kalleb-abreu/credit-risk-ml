...
- [ ] Identify a severely imbalanced dataset.
...
- [ ] Identify a near-balanced dataset.
- [ ] Download and verify class distribution.
- [ ] Perform EDA: summary stats, missing values, feature types, correlations.

**R Project Structure** 
- [ ] Search GitHub repos for ML project structures in R, look for patterns in `data/`, `R/`, `models/`, `output/`.
- [ ] Read Posit/tidyverse guidelines on project-oriented workflows.
- [ ] Search blogs for R project structure conventions. Keywords: *"R project structure machine learning"*, *"targets pipeline R"*.
- [ ] Check academic papers for how R ML studies organize scripts, data, and results.
- [ ] Document the chosen structure: raw vs. processed data, model saving, script naming conventions.
